...
def get_model(cfg, dataset=None):
    ...
    """
    # method_dict["conv_onet"]:
    # <module 'src.third_party.ConvONets.conv_onet' from
    # '/home/wuruihai/Ditto-master/src/third_party/ConvONets/conv_onet/__init__.py'>
    # 即调用src.third_party.ConvONets.conv_onet处的config中的get_model, 以cfg即最初的'network'为参数
